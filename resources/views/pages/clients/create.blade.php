                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="address" id="last-name" autocomplete="family-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            @error('address')
                                            <div class="pt-3 font-large text-red-600">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <input type="text" name="vat" id="email-address" autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            @error('vat')
                                            <div class="pt-3 font-large text-red-600">{{ $message }}</div>
                                            @enderror
                                        </div>
